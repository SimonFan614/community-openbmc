...
#define FMC_WDT_TIMEOUT             0x0a                /* 1 second (0x0a = 10 * 0.1sec) */
#define AST2600_WTD_TIMEOUT         0xe0                /* 22.4 seconds */
...
#define WDT_EC_TIMEOUT_DEFAULT          300

extern void fmc_enable_dual_boot(int timeout);
extern void fmc_disable_dual_boot_wtd(void);
