...
#define TPS53647_ID    (2)
#define TPS53622_ID    (3)
#define TPS53667_ID    (4)
...
static struct pmbus_driver_info tps53647_info = {
	.pages = TPS53647_PAGE_NUM,
			  ...
			  const struct i2c_device_id *id)
{
	...
	} else if ((id->driver_data) == TPS53647_ID || (id->driver_data) == TPS53667_ID) {
		info = devm_kmemdup(&client->dev, &tps53647_info, sizeof(*info), GFP_KERNEL);
	} else if ((id->driver_data) == TPS53622_ID) {
...
static const struct i2c_device_id tps53679_id[] = {
	...
	{"tps53647", TPS53647_ID},
	{"tps53622", TPS53622_ID},
	{"tps53667", TPS53667_ID},
	{}
};
...
static const struct of_device_id __maybe_unused tps53679_of_match[] = {
	...
	{.compatible = "ti,tps53647"},
	{.compatible = "ti,tps53622"},
	{.compatible = "ti,tps53667"},
	{}
};
